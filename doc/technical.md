...
- 平台元信息：meta.title=UMe Battle；category=action；uuid=e08819d5-0838-4757-9e2f-88f9f3045ad6
...
- `src/UmeBattle/UmeBattle.less`
- `src/UmeBattle/types.ts`
- `src/UmeBattle/index.ts`
- `src/UmeBattle/UmeBattle.tsx`
- `src/UmeBattle/utils/sounds.ts`
- `src/UmeBattle/components/SplashScreen.tsx`
